...
@Test func wuFindsTwoDominantColors() {
    ...
    let palette = WuQuantizationTechnique.extract(from: pixels, options: WuQuantizationOptions(colorCount: 2))
...
@Test func wuRespectsRequestedColorCount() {
    ...
    let palette = WuQuantizationTechnique.extract(from: pixels, options: WuQuantizationOptions(colorCount: 3))
